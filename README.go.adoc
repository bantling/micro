...
* conv handle union.maybe
** Useful to convert untyped nulls like json.NullValue into a struct field that is a Maybe[string]
...
* alter Makefile to drop docker support
* simple ORM
